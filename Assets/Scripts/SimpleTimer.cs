...
public class SimpleTimer
{
    ...
    /// </summary>
    public TimerType Type { get; set; } = TimerType.SUBTRACT;
    ...
    /// <summary>
    /// Called right after starting the timer
    /// </summary>
    ...
    {
        if (stepRetrieval is null) throw new ArgumentNullException("Step Retrieval cannot be null");
    ...
    /// Starts the timer.
    /// </summary>
    /// <param name="reset">If true, it will also reset the values of the timer</param>
