...
public class FakePlayerTester : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning("No se encontr� ning�n PlayerInputManager en la escena.");
        }
    }
    ...
    void Update()
    {
        ...
        // Puedes a�adir m�s teclas si quieres spawnear varios de golpe
    ...
    {
        // 1. Le decimos a Unity: "Cr�ate un mando de la nada y con�ctalo al PC"
        Gamepad mandoVirtual = InputSystem.AddDevice<Gamepad>();

        // 2. Le decimos a tu Manager que una a un jugador usando este nuevo mando
        // El -1, -1 significa que elija la ID de jugador y la variante de control autom�ticamente
